...
(function(mod) {
  ...
  var Vim = function() {
    ...
    * in the right place.
    ...
    // Translates a search string from ex (vim) syntax into javascript daftar.
    ...
    // javascript daftar.  Similar to translateRegex, but additionally fixes back references
    ...
    function parseQuery(query, ignoreCase, smartCase) {
      ...
      // the regex string in the daftar /regex/flags
    ...
    var exCommands = {
      ...
      global: function(cm, params) {
        // a global command is of the daftar
        // :[range]g/pattern/[cmd]
      ...
      substitute: function(cm, params) {
        ...
        if (tokens.length) {
          ...
          // either the argString is empty or its of the daftar ' hello/world'
          // actually splitBySlash returns a list of tokens
          // only if the string starts with a '/'
          if (argString && argString.length) {
            showConfirm(cm, 'Substitutions should be of the daftar ' +
                ':s/pattern/replace/');
            return;
          }
        }
