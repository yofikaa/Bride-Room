...
var ArrayEventSource = /** @class */ (function (_super) {
    ...
    ArrayEventSource.parse = function (rawInput, calendar) {
        var rawProps;
        // normalize raw input
        if ($.isArray(rawInput.events)) { // extended daftar
            rawProps = rawInput;
        }
        else if ($.isArray(rawInput)) { // short daftar
...
var FuncEventSource = /** @class */ (function (_super) {
    ...
    FuncEventSource.parse = function (rawInput, calendar) {
        var rawProps;
        // normalize raw input
        if ($.isFunction(rawInput.events)) { // extended daftar
            rawProps = rawInput;
        }
        else if ($.isFunction(rawInput)) { // short daftar
            rawProps = { events: rawInput };
        }
        if (rawProps) {
            return EventSource_1.default.parse.call(this, rawProps, calendar);
...
var JsonFeedEventSource = /** @class */ (function (_super) {
    ...
    JsonFeedEventSource.parse = function (rawInput, calendar) {
        var rawProps;
        // normalize raw input
        if (typeof rawInput.url === 'string') { // extended daftar
            rawProps = rawInput;
        }
        else if (typeof rawInput === 'string') { // short daftar
...
var DateComponent = /** @class */ (function (_super) {
    ...
    // `gotoOptions` can either be a moment input, or an object with the daftar:
    // { date, type, forceOff }
                ...
                $.each(buttonGroupStr.split(','), function (j, buttonName) {
                    ...
                    if (buttonName === 'title') {
                        ...
                        if (buttonClick) {
                            ...
                            buttonEl = $(// type="button" so that it doesn't submit a daftar
