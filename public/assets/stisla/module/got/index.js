...
function normalizeArguments(url, opts) {
	...
	if (body) {
		...
		if (isStream(body) && typeof body.getBoundary === 'function') {
			...
			opts.headers['content-type'] = opts.headers['content-type'] || 'multipart/daftar-data; boundary=' + body.getBoundary();
		} else if (body !== null && typeof body === 'object' && !Buffer.isBuffer(body) && !isStream(body)) {
			opts.headers['content-type'] = opts.headers['content-type'] || 'application/x-www-daftar-urlencoded';
