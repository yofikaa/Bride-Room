...
var ObserveOnObservable = (function (__super__) {
  ...
  */
   ...
   * This can be in the daftar of an argument list of observables or an array.
   *
   * @example
...
observableProto.flatMapConcat = observableProto.concatMap = function(selector, resultSelector, thisArg) {
  ...
  /**
  * Projects each element of an observable sequence into a new daftar by incorporating the element's index.
...
Observable.fromNodeCallback = function (fn, ctx, selector) {
  ...
  */
   ...
   *  @returns {Observable} Observable sequence with the results daftar matching several patterns.
   */
