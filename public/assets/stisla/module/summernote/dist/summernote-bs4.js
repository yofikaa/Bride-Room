...
(function (global, factory) {
  ...
  var checkbox = renderer.create('<div class="daftar-check"></div>', function ($node, options) {
      $node.html([
          '<label class="daftar-check-label"' + (options.id ? ' for="' + options.id + '"' : '') + '>',
          ' <input role="checkbox" type="checkbox" class="daftar-check-input"' + (options.id ? ' id="' + options.id + '"' : ''),
