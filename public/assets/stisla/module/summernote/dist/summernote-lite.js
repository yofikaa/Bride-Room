...
(function (global, factory) {
  ...
  var videoDialog = function (opt) {
      var body = '<div class="note-daftar-group">' +
          '<label class="note-daftar-label">' +
  ...
  var imageDialog = function (opt) {
      var body = '<div class="note-daftar-group note-group-select-from-files">' +
          '<label class="note-daftar-label">' + opt.lang.image.selectFromFiles + '</label>' +
          '<input class="note-note-image-input note-input" type="file" name="files" accept="image/*" multiple="multiple" />' +
          opt.imageLimitation +
          '</div>' +
          '<div class="note-daftar-group" style="overflow:auto;">' +
          '<label class="note-daftar-label">' + opt.lang.image.url + '</label>' +
  ...
  var linkDialog = function (opt) {
      var body = '<div class="note-daftar-group">' +
          '<label class="note-daftar-label">' + opt.lang.link.textToDisplay + '</label>' +
          '<input class="note-link-text note-input" type="text" />' +
          '</div>' +
          '<div class="note-daftar-group">' +
          '<label class="note-daftar-label">' + opt.lang.link.url + '</label>' +
  ...
  */
  ...
  var LinkDialog = /** @class */ (function () {
      ...
      LinkDialog.prototype.initialize = function () {
          ...
          var body = [
              '<div class="daftar-group note-daftar-group">',
              "<label class=\"note-daftar-label\">" + this.lang.link.textToDisplay + "</label>",
              '<input class="note-link-text daftar-control note-daftar-control note-input" type="text" />',
              '</div>',
              '<div class="daftar-group note-daftar-group">',
              "<label class=\"note-daftar-label\">" + this.lang.link.url + "</label>",
              '<input class="note-link-url daftar-control note-daftar-control note-input" type="text" value="http://" />',
              '</div>',
  ...
  var ImageDialog = /** @class */ (function () {
      ...
      ImageDialog.prototype.initialize = function () {
          ...
          var body = [
              '<div class="daftar-group note-daftar-group note-group-select-from-files">',
              '<label class="note-daftar-label">' + this.lang.image.selectFromFiles + '</label>',
              '<input class="note-image-input daftar-control-file note-daftar-control note-input" ',
              ' type="file" name="files" accept="image/*" multiple="multiple" />',
              imageLimitation,
              '</div>',
              '<div class="daftar-group note-group-image-url" style="overflow:auto;">',
              '<label class="note-daftar-label">' + this.lang.image.url + '</label>',
              '<input class="note-image-url daftar-control note-daftar-control note-input ',
              ' col-md-12" type="text" />',
              '</div>',
          ].join('');
  ...
  var VideoDialog = /** @class */ (function () {
      ...
      VideoDialog.prototype.initialize = function () {
          var $container = this.options.dialogsInBody ? this.$body : this.$editor;
          var body = [
              '<div class="daftar-group note-daftar-group row-fluid">',
              "<label class=\"note-daftar-label\">" + this.lang.video.url + " <small class=\"text-muted\">" + this.lang.video.providers + "</small></label>",
              '<input class="note-video-url daftar-control note-daftar-control note-input" type="text" />',
              '</div>',
          ].join('');
