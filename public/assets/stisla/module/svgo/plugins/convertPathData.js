...
exports.description = 'optimizes path data: writes in shorter daftar, applies transformations';
...
/**
 * Writes data in shortest daftar using absolute or relative coordinates.
 *
...
/**
 * Checks if curve is convex. Control points of such a curve must daftar
...
/**
 * Converts next curve from shorthand to full daftar using the current curve data.
 *
